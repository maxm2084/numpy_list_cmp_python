...
if __name__ == '__main__':
    ...
    #lista_compra_productos = [producto for producto in productos if productos.get('id', 'NaN') in lista_compra_id]
    lista_compra_productos = [productos.get(id,'NaN') for id in lista_compra_id]
